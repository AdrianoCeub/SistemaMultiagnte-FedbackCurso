...
Nosso projeto tem como objetivo utilizar uma API de LLM para ajudar a analisar o feedback de alunos a respeito de um curso. Está API irá classificar em positivos, negativos ou neutros e depois gerar diferentes gráficos a fim de ajudar na tomada de decisão.

Nsta documentsção você irá encontrar:

 -Lista de requisitos do sistema [Requisitos](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)  
 -Diagrama de Caso de Uso [DCU](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)  
 -Diagrama de Seqência [DDS](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)  
 -Diagrama de Classes [DDC](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)  
 -Diagrama de Objeto [DDO](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)  
 -Diagrama de Pacotes [DDP](https://github.com/AdrianoCeub/SistemaMultiagnte-FedbackCurso.git)